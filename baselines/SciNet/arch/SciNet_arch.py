...
class SciNet(nn.Module):
    ...
    Link: https://arxiv.org/pdf/2106.09305.pdf
    Ref Official Code:
        https://github.com/cure-lab/SCINet
    """
    def __init__(self, input_len, output_len,  input_dim, hid_size=1, num_stacks=1,
                 num_levels=3, num_decoder_layer=1, concat_len=False, groups=1, kernel=5, dropout=0.5,
                 single_step_output_One = False, positionalE = False, modified=True, RIN = False):
