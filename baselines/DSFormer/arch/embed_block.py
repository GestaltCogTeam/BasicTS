...
class embed(nn.Module):
    def __init__(self,Input_len, num_id,num_samp,IF_node):
        ...
        self.mask_emb = nn.Parameter(torch.empty(num_id, Input_len))
        nn.init.xavier_uniform_(self.mask_emb)
    ...
    def forward(self, x):
        ...
        node_emb2 = self.mask_emb.unsqueeze(0).expand(batch_size, -1, -1).unsqueeze(-1)
