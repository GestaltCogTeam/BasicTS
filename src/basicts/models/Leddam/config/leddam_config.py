...
@dataclass
class LeddamConfig(BasicTSModelConfig):
    ...
    period: int = field(default=64, metadata={"help": "Period for autoregressive attention."})
    ...
    kernel_size: int = field(default=25, metadata={"help": "Kernel size for learnable decomposition."})
