...
def generate_data(args):
    ...
    Default settings of solar-energy dataset:
        - Normalization method: standard norm.
        - Dataset division: 6:2:2.
        - Window size: history 168, future 12.
        - Channels (features): three channels [solar power output, time of day, day of week]
        - Target: predict the solar power output of the future 12 time steps.
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_file_path", type=str,
                        default=DATA_FILE_PATH, help="Raw solar power output readings.")
