...
def generate_data(args: argparse.Namespace):
    ...
    Default settings of Electricity dataset:
        - Normalization method: standard norm.
        - Dataset division: 6:2:2.
        - Window size: history 168, future 12.
        - Channels (features): three channels [electricity consumption, time of day, day of week]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_file_path", type=str,
                        default=DATA_FILE_PATH, help="Raw electricity consumption readings.")
