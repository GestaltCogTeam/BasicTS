...
def generate_data(args):
    ...
    Default settings of Beijing air quality dataset:
        - Normalization method: standard norm.
        - Dataset division: 6:2:2.
        - Window size: history 168, future 12.
        - Channels (features): three channels [Beijing air quality, time of day, day of week]
        - Target: predict Beijing air quality index(AQI) of the future 12 time steps.
...
if __name__ == "__main__":
    ...
    DATASET_NAME = "Beijing_air_quality"
    ...
    parser.add_argument("--data_file_path", type=str,
                        default=DATA_FILE_PATH, help="Raw air quality readings.")
