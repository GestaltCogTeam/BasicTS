import torch
from basicts.runners.base_traffic_runner import MTSRunner

class GMANRunner(MTSRunner):
    ...
    def forward(self, data: tuple, epoch:int = None, iter_num: int = None, train:bool = True, **kwargs) -> tuple:
        ...
        # feed forward
        prediction_data = self.model(history_data=history_data, future_data=future_data)     # B, L, N, C
