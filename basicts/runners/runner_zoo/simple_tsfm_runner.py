...
class SimpleTimeSeriesFoundationModelRunner(BaseTimeSeriesFoundationModelRunner):
    """
    ...
    def forward(self, data: Dict, iter_num: int = None, train: bool = True, **kwargs) -> Dict:
        """
        ...
        model_return = self.model(history_data=history_data, future_data=future_data_4_dec, 
                                  batch_seen=iter_num, epoch=None, train=train)
