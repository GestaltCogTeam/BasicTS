...
INPUT_LEN = 36 # better results than regular_settings['INPUT_LEN'] (336)
OUTPUT_LEN = 36  # Length of output sequence
...
CFG.TRAIN.LOSS = partial(selective_mse, mask_ratio = 0.2)
CFG.TRAIN.COV_MASK_RATIO = 0.0
# Optimizer settings
