...
"""
    ...
    Note: 
        ...
        Some details can be found in the appendix in the original paper and similar issues in its official repository: https://github.com/chaoshangcs/GTS/issues
    Ref Official Code: 
...
class GTS(nn.Module, Seq2SeqAttrs):
    ...
    def forward(self, history_data, future_data=None, batch_seen=None, epoch=None):
        """
        :param inputs: shape (seq_len, batch_size, num_sensor * input_dim)
